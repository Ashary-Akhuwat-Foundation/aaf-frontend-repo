		...
		<div className='container-fluid description-container'>
			...
			<div className='d-flex flex-column align-items-center justify-content-center text-center pt-4'>
				<div className='des-div'>
					...
					<p>
						You'll find the venue brimming with thoughtfully-selected art
						pieces. Take your time browsing and selecting the pieces that speak
						to you.
					</p>
					<p>
						Are you interested in submitting your art to the show? Follow the
						link below and we'll be in touch.
					</p>
				...
				<div className='des-div'>
					...
					<p>
						Not local or can't make it to the show? No worries, you have an
						option to experience the event from wherever you are. RSVP to our
						virtual auction to receive a link once we go live.
					</p>
